COMMON_SOURCES=game_data.cpp grid_tree.cpp terrain_object.cpp game_base_data.cpp fleet.cpp solar.cpp ship.cpp waypoint.cpp research.cpp game_settings.cpp serialization.cpp socket_t.cpp command.cpp utility.cpp types.cpp cost.cpp game_object.cpp upgrades.cpp interaction.cpp development_tree.cpp ship_stats.cpp
