...
server_objects = game_data.o server.o game_handler.o com_server.o grid_tree.o fleet.o
client_objects = client.o graphics.o client_game.o com_client.o selector.o
common_objects = game_settings.o serialization.o socket_t.o command.o utility.o types.o
