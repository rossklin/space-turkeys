...
* [!] issues
** [!] crashes
*** random_uniform called with b = inf
** [~] system
*** trade actions can't swap fleet action 
...
** [~] gui 
*** selecting in development_gui resets scroll
...
* [!] system design ideas
** possibility to find "treasures" when discovering new solar systems
   Combined with a new detection level stat of some kind.
** new better universe builder, possibly generate while exploring
...
** reduce sent data using an instruction based model
...
** add some tech/facility for pop crowd, ecology, water and space
* to be tested
** confirm
*** [J?] "space_status: used more than space" reached after developing facility
*** [J?] "maintain course" not respected
*** [J?] fleets need to unset idle/converge on receiving a command with long distance
*** [J?] interaction space combat should default to aggresive policy
*** [J?] add/fix bombard animation
*** [J?] runtime_error("Analyze enemies: clusters failed to form!");
*** [J?] ships don't seem to respect fleet speed limit
*** [J?] fleets seem to idle when reaching solar before all ships land
*** [J?] fleet summon doesn't seem to work very well
*** [J?] movement is too slow in relation to development
*** [J?] animations move too fast - bind them to frames!
*** [J?] progress bar goes behind right panel
*** [J?] upgraded fighters have too much health vs damage
*** [J?] research completes too fast
*** [J?] sector boosts apply exponentially with level and should be lower
*** [J?] mining is too efficient
*** [J?] default ship assignment for special action should be one compatible ship
*** [J?] log panel grows sideways off screen, info panel follows
*** [J?] state of water, space and ecology of new solars is too random
*** [J?] issue with clumsy ships
**** [J?] Ships collide while travelling in fleet
    Test: check free space on either side
**** [J?] big ships are too clumsy and collide when courses intersect
    Disable collisions, increase anglular rotation speed, give ships
    correct angle on liftoff.
...
*** [J?] population adapts too quickly to circumstances e.g. space
*** [J?] deleting command does not cause command to be removed on server
*** [J?] large ships rotate too slow
*** [J?] large ships are too large
*** [J?] add ship::request_update that fleet can set on e.g. passing a waypoint
