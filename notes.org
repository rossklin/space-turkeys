...
** play test
   Mining is OP
   People should be more unhappy! About crowding for example...
   Fleets a bit hard to see
   Small enemy ships IMPOSSIBLE to see!
   Range of vision difficult to see
   Solar hover_info should show ship class counts
   Initiating action trade_to doesn't load cargo
