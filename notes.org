...
** play testing
*** test that turrets work
*** custom key bindings och eller wasd kontroller
*** commands between waypoints shown/not shown randomly during simulate
*** initial missile turret gets shot down by initial fighter
*** progress bars for production
*** possibility to manually override production at solar
*** warp drive not listed for colonizers
*** ship attack trajectories update too slow
*** [!] Server segfaults if client disconnects during introduction
...
*** governor: add weight if a development would increase empire's max facility level
