...
*** finish implementing new serialization/deserialization
*** fix client game reloading of waypoints
*** implement client game deserialize of game data
*** remove game_data deserialize operator
...
*** consider effects of client game data not containing all ships for contained entities
    though a client should always receive all their owned ships.
*** change identifier::some_class_id to the_class::class_id
* [~] issues
** [~] bugs & crashes
