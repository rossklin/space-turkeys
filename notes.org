...
** show unmet requirements for development::nodes with no dependencies
...
** form fleet with F doesn't work
** right click with selected ships creates waypoint with no incident commands
** ship upgrades e.g. warp drive do not respect e.g. !small for scout
...
* content ideas
** techs
*** general: qualitative advantages that require high facility level
*** stealth: give ships a stealth attribute that counters the vision attribute
* to be tested
** confirm
