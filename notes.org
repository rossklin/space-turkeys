...
* bugs
* issues
** when attempting to target a solar with a fleet on, the fleet is targeted
** solar gui
*** solar gui is ugly
...
*** all increments are off
** comgui click position is off
** difficult to understand
*** population dynamics (happy/production/growth)
*** effects of research etc.
*** assigning ships in chained commands
*** conquering and colonizing, defense visualizer
** stars appear in lumps
   generate outside vision in intermediate buffer?
