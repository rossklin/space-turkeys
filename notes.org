* current work
** replace references to ship stats
** implement use of mass stat for detection, accuracy and graphics scale
** implement use of evasion stat to counter accuracy
** implement remaining ship_stats functions
** remove physical_object::interact, call interactions in move phase
** make solar call interactions in move phase
** make fleet analytics use ship size to determine enemy strength
** make fleet::suggest use enemy strength factor
** implement ship::move using fleet::suggest
** consider letting fleet suggestion contain an angle?
** update ship data with regard to accuracy/mass/evasion interaction
...
** system
*** need a way to handle conflicting upgrade stats e.g. mass for nano scout
* system design ideas
...
** increase build times for everything
** increase ship fire rate
** make ships in fleets group together
...
* content ideas
** add some heavier ship classes
** add some tech/facility for "medicine" that population crowding coefficient
* to be tested
** confirm
