...
*** rewrite json access loops using special MemberBegin and Begin
*** look over serialization of all new types
*** write solar_data.json
*** replace ship_allocation with lookup keys in ship::table
