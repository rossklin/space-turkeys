...
*** insert + make_split loop in grid_tree causes segfault
    After giving a waypoint with some units an empty command "space combat"
*** Colonize and join fleet commands are abandoned
*** Need to remove "unseen" units when the area becomes seen
*** [J] Segfault 
