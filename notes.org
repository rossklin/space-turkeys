...
** play testing
*** governor doesn't seem to chose a development
*** [J?] solar selector hover needs to show developments
*** need to actively query user when new research can be chosen
*** test that techs show fulfilled faciltiy req 
* [~] issues
** [~] system
...
* tweaks and fixes
** gui
*** show selection info instead of hover info when no hover
