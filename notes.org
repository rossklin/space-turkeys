...
** Hang in tester -> increment -> ship_move -> grid_tree::move
...
** Perf shows server spends most time in grid_tree::search, mostly in rebuild_evm
  Also ship::update_data spends most time grid_tree::search, not in apply_ship
  Ideas:
  Separate pos_index from metadata to avoid copying index when fetching metadata
  Use KNN instead of radius search to avoid looking up and copying all ships when only a few are needed

      + 12,50% st3::grid::tree<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >::info::info                                                                              ▒
      + 9,09% std::map<std::pair<int, int>, std::set<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::less<std::__cxx11::basic_string<char, std::char_traits<char>, s▒
      + 7,46% std::map<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, st3::grid::tree<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >:▒
      + 6,72% st3::grid::tree<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >::info::~info                                                                              ▒
      + 5,07% std::set<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::less<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >, std::▒

** Fix partial invalidation for GUI components (ie scrolling list lowers frame rate to 10 fps)
** Simulation progress bar resets to 0 when data runs out
** Generated frames label only updated when playing
** Reload data takes ~1 s with 500 ships in air, running sim on server takes some secs, show load in progress bar
