...
** rewrite solar/gui
*** build sfgui central object somewhere, e.g. in client_game::run?
...
*** client_game::build_choice should build main_interface
*** client_game::build_choice should run interface event/draw loop
