...
** rewrite solar/gui
*** decide whether expansion should be a sector and/or have sub choices
*** continue implementing solar_gui.cpp
*** rewrite event handler for activating solar gui and new research gui
*** implement seperate research gui
*** finish cost.cpp
*** apply updated solar.h in game_data::solar_tick
