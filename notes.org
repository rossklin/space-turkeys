...
*** introduce some geometric information for interfaces, e.g. in main_interface constructor
*** include solar sub queries in solar main window
*** implement all graphics::interface interfaces
