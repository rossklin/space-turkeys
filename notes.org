* current work
** build log in client_game and add widget
...
** redesign solar_gui
*** add research_gui: wrap new development_gui with ok/cancel + progress
*** [J] use solar_selector::choice_data instead of desktop -> response.solar_choices
*** make client::game::build_chioce use choice data from solar selectors
*** [J] three tabs: sectors, development, military
*** [J] sectors: remove template buttons
*** remove research::solar_template_table
*** development: show current choice and progress
*** [J] allow selecting multiple templates, multiple ships but only one dev
*** mining: automatically prioritize what is available inversely to storage
*** development choice is forgotten by opening and closing solar gui
*** [J?] solar gui defaults to zeros even though choice_data is sent
** log research and facility completion
** show current research choice and progress in gui
* [!] issues
** [!] crashes
...
** [~] gui 
*** available developments should also be in a scroll-window
*** priority buttons unresponsive to first right click
*** Clicking interface response button also triggers click on minimap
*** available developments' build button should be bottom aligned
*** development req list is not left-aligned
