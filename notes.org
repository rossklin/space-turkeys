* current work
** [J] removed ship combat stats
** [J] added ship interaction definitions
** reintroduce ship combat stats
** finish ship templates and use ship::receive_damage
** determine who is responsible for load time
** fix calling ship interactions from game data
** consider introducing a game_data::find_targets
   Conditioned on a ship::target_condition and a radius
** consider introducing a ship::tick function
   It could be responsible for relating interactions to load time in a
   dynamical way. This may be a tad more complex than nessecary.
* [~] issues
** [~] bugs & crashes
