...
*** solar choice for invalid player after conquering solar
*** make fleet selectors for enemy fleets
*** ships should auto-engage
*** newly colonized solars' dynamics generate NaN in all fields
*** idle shouldn't be an action
*** join fleet shouldn't be an action - use waypoints
