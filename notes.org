...
* basic goals
** server game
*** make solars more different
*** neutral solars should start with less industry
...
* issues
** tgui cmake requires that sfml libraries exist
   ...
   temp: manually remove dep check or run make twice
