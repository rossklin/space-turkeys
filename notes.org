...
** play testing
*** add standby communication so socket_t doesn't timeout during choice step
*** research gui
**** distinguish between already researched and can't research
**** show progress
*** minimap too transparent
*** solars stuck in terrain
...
* [~] issues
** [~] system
*** terrain still creates intersections and unreachable areas which bug out the path search algorithm
