...
** play testing
*** starting_fleet: massive, in apply choice: entity not found: ship:29
*** make collisions conserve energy
    e = 0.5 m v²
    de/dt = m v dv/dt
    dv = f / m dt
    ...
    the position.
*** population dynamics change too fast, e.g. switching to military gov 1 turn killed 20% of ppl
