* current work
** fix solar gui to fit new solar choice
** new structure using JSON files for upgrades, ships and research
*** implement solar::development_tree::facility_tree()
*** fix references to e.g. research::data::tree
*** write game_data::confirm_data that loads data and validates references
* [!] issues
** [!] bugs & crashes
