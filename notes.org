...
*** landed on negative development points after completing expansion factories
*** development choice is forgotten by opening and closing solar gui
*** solar gui defaults to zeros even though choice_data is sent
*** log research and facility completion
*** show current research and facility choice and progress in gui
* [!] issues
** [!] crashes
