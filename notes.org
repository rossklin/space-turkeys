...
*** give commands to remaining waypoints
...
* bugs
** fleet radius can decrease indefinitely
** fleets with deleted command continue on old command
   should get "idle" command
** waypoints created when no sources selected
