...
*** [I] define choice::c_research
*** [I] research::data constructor
*** [I] research::data + choice::c_research serialization
*** [I] research choice gui
* system design ideas
** make all interactions be buffered and then evaluated in post phase (remove solar post phase stuff)
** make landing be an interaction
** reduce fleet actions, replace with fleet response policies
** remove targeting of fleets 
   enables removing interaction::macro_valid
   fixes target tracking issues
   allows client to reform fleets freely
...
* [!] issues
** [!] bugs & crashes
*** when attacking solar: ends at: distributed -1 of 99 frames to 0: end
    Did send 99% of frames to client. Does not pass "client x is done".

    May be caused by breaking to long during load in debugger?
