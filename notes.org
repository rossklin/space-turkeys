...
** server game
*** fog of war
**** give ships attribute sfloat vision
**** give fleets attribute sfloat vision
**** add fleet.vision to serialisation
**** update fleet.vision in update_fleet_data()
**** give solars attribute vision
