...
Perhaps check if there is empty space in direction of fleet center?
** How to handle deploy action for multiship fleet
** Fighters bounce absurdly when colliding slowly with battleships
** Consistent network error pressing done in simulation before other client pressed commit
