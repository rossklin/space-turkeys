...
** One ship teleported to edge of other terrain
  Maybe related to new push out of terrain mechanism
** Client hit "Attempting to build invalid command"
...
** Fleet path does not include first vertice when fleet center is adjacent to terrain.
  Causes ships to get stuck heading into wall
** Fleet center gets stuck against terrain wall
...
** Implement fleet::request_helper_fleet
...
** Issue with pathing again, path was suboptimal and passed through terrain
