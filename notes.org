* current work
** main_interface::reset_qw() does not clear command_gui radio buttons
** command_gui ship buttons cover complete table
** graphics::ship_button drawn on weird angle
