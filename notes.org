...
** Alternative movement approach3
   ...
   Consider giving ships individual fleet_path_index
   Save and serialize ship pathing policy choice to visualize for debug in client
   Client is still messing up fleet position somehow
