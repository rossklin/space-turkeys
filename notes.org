...
*** Check that commit is disabled for main panels until choice is selected
*** Make main panel prevent click event propagation
*** Hover info shows nothing, does not fit in window
*** Event log and hover info should be 100% width or transparent background
*** Military GUI 
**** shows techs instead of ships
*** Choice GUI 
**** description lists should have smaller text and smaller top-bottom-margins
**** content should be center-aligned
*** Command GUI
**** Slider does not show
**** Ship list to wide for window
