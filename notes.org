...
** add ship::request_update that fleet can set on e.g. passing a waypoint
*** ship decided to leave waypoint after fleet arrived, then was told to hold at distant position
* [!] issues
** [!] system
*** client allows multiple development choices - server does not
    Redesign: chose development in advance like everything else
*** [?] command selector policies uninitialized after reload
    Happened after fleet was idle at waypoint through round
*** Ships collide unnessecarily
...
** [~] gui 
*** no delete button in command_gui
...
* content ideas
** add some tech/facility for "medicine" that affects population crowding coefficient
* to be tested
** confirm
