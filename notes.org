* current work
** add debug printouts and run through fleet suggest and fleet analyze enemies
*** [J?] fleet always selects evade towards target position 
    check enemy strength cirkular kernel estimate
* [!] issues
** [!] system
