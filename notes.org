* current work
** fleets should try to set scatter point towards owned solar
** fleets should try not to change the scatter point
** fleets should suggest travel instead of scatter if target direction is free
** remake command gui to handle fleet policies
