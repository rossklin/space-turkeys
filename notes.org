...
** Arrival to waypoint, fleet idles but next command removed instead of triggered
** Evasive fleet policy does not work (well enough)
** Must allow client to create fleets agin
** Waypoint becomes impossible to select after first select or movement
