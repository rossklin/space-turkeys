* current work
** continue splitting up interfaces
** make new "development" interface that can be used for research and facilities
** allow selecting not to develop solar facilities
