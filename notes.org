...
** [~] gui 
*** solars don't show player colors
...
** system
*** slow down when entering combat
*** ships shoot a bit far
    make distance part of accuracy check and apply it in ship::move when checking shootability
