* current work
** path search
   Handle infinite recursion when there is no viable path.
** balancing
...
* [~] issues
** [~] system
*** ships should not be able to enter impassable terrain
*** ships should move slower and rotate faster in order to navigate geometries
