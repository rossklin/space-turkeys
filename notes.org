...
*** Update json file refs to data directory
*** Save files in save directory
*** Re-implement all SFGUI components in RSG
*** Restructure main window loop and event handling
