...
*** command_gui sort ships by type
...
* bugs
** segfault when deleting command to waypoint
** undefined when deleting command with active comgui
** fleet position seems to be off
** client rectangle upwards select does not work
** comgui effects handler doesn't recursively reset waypoint ships
