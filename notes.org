...
** play testing
*** reduce research facility level req to level 3
*** military should also prefer building defensive facilities
*** start with missile turret level 1
*** fleet hover info should show ship counts
*** don't give orders to send 0 units
...
*** show ship class counts in fleet hover info
*** draw fleets' primary ship and count in flag
*** people become *very* unhappy under military and development governors
*** fleeing units freeze in panic
*** red should not be a player color
*** treasure should only discover techs that are "next in line"
*** governor
**** happiness and population change too fast
...
*** fleet flags should be filled (and outlined?) so you can always see them
