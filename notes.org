* current work
** guarantee good nsolar in starting area
** solars too tightly packed
** zoom still doesn't run during simulation
** make solar dynamics use sectors medicine and ecology
