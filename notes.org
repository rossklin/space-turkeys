...
** play testing
*** empty option added for governor gui
*** combat log sometimes repeats entries (at start/end of turn?)
*** ship count box has unscaled text - unscale whole box
*** ship count box frame gets fat when many rows
* [~] issues
** [~] system
...
* tweaks and fixes
** gui
*** consider making battle log be one label since building it seems to lag a bit
*** explosion animation wave should fade faster and not turn back inwards
*** fleet selectors a bit ugly with seperate ring and flag
*** choice_gui buttons: graphics bugs when setting border width
